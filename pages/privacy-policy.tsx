...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - SethDrums Song Panel</title>
      </Head>
      <Container marginBottom={10}>
        <Stack gap={2}>
          <Heading as='h1' size='xl' noOfLines={1}>Privacy Policy</Heading>
          <p>Last updated: February 04, 2023</p>
          ...
          <Heading as='h1' size='xl' noOfLines={1}>Interpretation and Definitions</Heading>
          <Heading as='h2' size='lg' noOfLines={1}>Interpretation</Heading>
          <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
          <Heading as='h2' size='lg' noOfLines={1}>Definitions</Heading>
        ...
        <UnorderedList>
          ...
          <ListItem>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SethDrum LLC, 104 Zion St. Anderson MO. 64831.</p>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <p><strong>Website</strong> refers to SethDrums Song Panel, accessible from <a href="https://sethdrums.com" rel="external nofollow noreferrer" target="_blank">https://sethdrums.com</a></p>
          </ListItem>
          <ListItem>
        ...
        <Stack gap={2}>
          ...
          <Heading as='h2' size='lg' noOfLines={1}>Types of Data Collected</Heading>
          <h3>Personal Data</h3>
        ...
        <Heading as='h2' size='lg'>Use of Your Personal Data</Heading>
        ...
        <Heading as='h2' size='lg' noOfLines={1}>Retention of Your Personal Data</Heading>
        ...
        <Heading as='h2' size='lg' noOfLines={1}>Transfer of Your Personal Data</Heading>
        ...
        <Heading as='h2' size='lg' noOfLines={1}>Delete Your Personal Data</Heading>
        ...
        <Heading as='h2' size='lg' noOfLines={1}>Disclosure of Your Personal Data</Heading>
        ...
        <Heading as='h2' size='lg' noOfLines={1}>Security of Your Personal Data</Heading>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        <Heading as='h1' size='xl' noOfLines={1}>Children{`'`}s Privacy</Heading>
        ...
        <Heading as='h1' size='xl' noOfLines={1}>Links to Other Websites</Heading>
        <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party{`'`}s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
        <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
        <Heading as='h1' size='xl' noOfLines={1}>Changes to this Privacy Policy</Heading>
        <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
        <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
        <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
        <Heading as='h1' size='xl' noOfLines={1}>Contact Us</Heading>
        <p>If you have any questions about this Privacy Policy, You can contact us at: <Link href='mailto:sethdrumstv@gmail.com'>sethdrumstv@gmail.com</Link></p>
      </Container>
    </>
  );
}
